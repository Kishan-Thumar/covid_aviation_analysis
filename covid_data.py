...
def send_data_to_S3():
    covid_api = 'https://api.covidactnow.org/v2/states.timeseries.csv?apiKey=136aeb345b644c58ac63bcbc5e62597a'
    response = urllib.request.urlopen(covid_api)
    conn = S3Connection("AKIAZQF7QBFO5FGNOUK7","nLdCwE8ftF73OMXs9x2xKz2y5bBb4AtWdb7i4G+N",host='s3.us-west-2.amazonaws.com')
